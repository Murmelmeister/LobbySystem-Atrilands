...
public enum Messages {
    ...
    PERMISSION_SPAWN_USE("Permission.Spawn.Use", "lobbysystem.command.spawn.use"),
    ...
    MESSAGE_LOBBY_SYSTEM_SYNTAX("Message.LobbySystem.Syntax", "<#ff0000>Syntax: /lobbysystem [reload]"),
